...
class SkillDatabase {
  skillsData: Record<string, Record<string, string[]>> = {
    ...
    other: {
      ...
      "content writing": ["content writing", "content writer", "blog writing", "article writing", "web content"],
      copywriting: ["copywriting", "copywriter", "marketing copy"],
      "content strategy": ["content strategy", "content strategist"],
      editing: ["editing", "copy editing", "proofreading"],
      storytelling: ["storytelling"],
      "social media": ["social media", "social media management", "social media strategy"],
      branding: ["branding"],
      ...
      "brand voice": ["brand voice", "tone of voice"],
      training: ["training", "enablement", "workshops"],
...
const jobProfiles: JobProfile[] = [
  ...
  },
  {
    ...
    summary: "Produce compelling visual assets across digital and print mediums.",
    coreSkills: ["graphic design", "branding", "visual communication", "photoshop", "illustrator", "indesign"],
    complementarySkills: ["typography", "layout", "illustration", "canva", "storytelling", "presentation"],
  },
  {
    title: "Data Engineer",
  ...
  },
  {
    ...
    summary: "Plan and craft engaging content that aligns with brand voice and SEO goals.",
    coreSkills: ["content writing", "copywriting", "content strategy", "seo", "editing", "research"],
    complementarySkills: ["social media", "email marketing", "storytelling", "brand voice", "client communication", "analytics"],
  },
  {
    title: "Marketing Specialist",
    summary: "Execute multi-channel marketing campaigns and measure performance.",
    coreSkills: ["digital marketing", "marketing", "seo", "analytics", "campaign management", "social media"],
    complementarySkills: ["content strategy", "email marketing", "copywriting", "crm", "branding", "presentation"],
  },
  {
    title: "Project Coordinator",
    summary: "Coordinate timelines, resources, and communication across project teams.",
    coreSkills: ["project management", "time management", "stakeholder management", "communication", "scheduling", "documentation"],
    complementarySkills: ["problem solving", "risk management", "teamwork", "client communication", "presentation", "agile"],
  },
  {
    title: "Customer Success Manager",
    summary: "Champion customer outcomes through proactive engagement and enablement.",
    coreSkills: ["customer service", "client communication", "crm", "problem solving", "relationship management", "analytics"],
    complementarySkills: ["presentation", "training", "communication", "project management", "negotiation", "product knowledge"],
  },
];
